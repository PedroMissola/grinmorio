...
## 1. Conceito de Sorte Diária e Probabilidade Ponderada
...
### 1.1. Analogia da Distribuição de Probabilidade
...
### 1.2. Tabela de Influência da Sorte
...
## 2. Mecânica de Rolagem e Integração de Modificadores
...
### 2.1. Fluxo de Dados (Input/Output)
...
### 2.2. A Integridade da Constante do Modificador
